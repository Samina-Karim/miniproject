...
test('same currency conversion', () => {
  const result = convertCurrency.default(cdnCurrency, cdnCurrency, 100)
...
test('CDN to GBP conversion', () => {
  const result = convertCurrency.default(cdnCurrency, gbpCurrency, 100)
...
test('CDN to USD conversion', () => {
  const result = convertCurrency.default(cdnCurrency, usdCurrency, 75)
...
test('USD to GBP conversion', () => {
  const result = convertCurrency.default(usdCurrency, gbpCurrency, 200)
...
test('GBP to CAD conversion', () => {
  const result = convertCurrency.default(gbpCurrency, cdnCurrency, 50)
